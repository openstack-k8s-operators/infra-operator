...
ARG IMAGE_COMPONENT="infra-operator-container"
ARG IMAGE_NAME="infra-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Infra Operator"
ARG IMAGE_DESC="This image includes the infra-operator"
