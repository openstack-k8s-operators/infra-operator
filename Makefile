...
test: manifests generate gowork fmt vet envtest ginkgo ## Run tests.
	...
	$(GINKGO) --trace --cover --coverpkg=./pkg/...,./controllers/...,./apis/network/v1beta1/...,./apis/rabbitmq/v1beta1/... --coverprofile cover.out --covermode=atomic ${PROC_CMD} $(GINKGO_ARGS) ./tests/... ./apis/network/... ./apis/rabbitmq/v1beta1/...
