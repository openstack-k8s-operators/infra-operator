...
func (r *Redis) ValidateCreate() (warnings admission.Warnings, err error) {
...
func (r *Redis) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
...
func (r *Redis) ValidateDelete() (warnings admission.Warnings, err error) {
