...
func (r *DNSMasq) ValidateCreate() (warnings admission.Warnings, err error) {
...
func (r *DNSMasq) ValidateUpdate(old runtime.Object) (warnings admission.Warnings, err error) {
...
func (r *DNSMasq) ValidateDelete() (warnings admission.Warnings, err error) {
