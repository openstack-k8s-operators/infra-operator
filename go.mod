...
require (
	...
	github.com/openstack-k8s-operators/infra-operator/api v0.0.0-00010101000000-000000000000
...
replace github.com/openstack-k8s-operators/infra-operator/api => ./api //allow-merging
