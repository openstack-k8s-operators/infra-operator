...
import (
	...
	redisv1beta1 "github.com/openstack-k8s-operators/infra-operator/api/redis/v1beta1"
)
...
// +kubebuilder:webhook:path=/mutate-redis-openstack-org-v1beta1-redis,mutating=true,failurePolicy=fail,sideEffects=None,groups=redis.openstack.org,resources=redis,verbs=create;update,versions=v1beta1,name=mredis-v1beta1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-redis-openstack-org-v1beta1-redis,mutating=false,failurePolicy=fail,sideEffects=None,groups=redis.openstack.org,resources=redis,verbs=create;update,versions=v1beta1,name=vredis-v1beta1.kb.io,admissionReviewVersions=v1
